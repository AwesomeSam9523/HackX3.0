  ...
  return (
    <Card className="mb-8">
      <CardHeader>
        ...
        <CardDescription>Provide your Google Meet link for online mentoring sessions</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {savedLink && (
          <Alert>
            ...
            <AlertDescription>Meet link saved. Teams will be notified via WhatsApp group.</AlertDescription>
          </Alert>
        )}
      </CardContent>
    </Card>
