      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mb-12">
          <div className="relative px-4 py-4">
            ...
            <span className="w-full text-2xl md:text-3xl font-kinetikaUltra tracking-tighter text-white uppercase">
              THIS IS YOUR CALL
            </span>
          </div>
        </div>
        ...
        <div className="mb-16 max-w-full text-center">
          <h1 className=" text-4xl font-kinetikaUltra tracking-wide uppercase md:text-5xl lg:text-6xl ">
