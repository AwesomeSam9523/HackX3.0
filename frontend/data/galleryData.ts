...
export const galleryData: GallerySection[] = [
  ...
  },
  {
    ...
    images: [
      { src: "/gallery/pic6.png", size: "tall" },
      { src: "/gallery/pic7.png", size: "small" },
      { src: "/gallery/pic8.png", size: "small" },
      { src: "/gallery/pic11.JPG", size: "small" },
      { src: "/gallery/pic9.png", size: "small" },
      { src: "/gallery/pic10.JPG", size: "large" },
    ],
  },
  {
    title: "MUJ2.0",
